...
SYNONYM_GROUPS: list[list[str]] = [
    ...
    # 能效等级（类别值：1级/2级/3级...，与能效比区分开）
    ["能效等级", "能效级别", "能耗等级"],
    # 能效比（数值：3.6 / 4.0...，与能效等级区分开）
    ["能效比", "能效比_制冷", "能效比_制热", "能效"],
    # 型号 vs 类型（型号是具体产品编号，类型是类别，必须区分）
    ["型号", "型号名称", "型号编码", "处理器型号", "显卡型号",
     "蓝牙芯片型号", "CPU型号", "产品型号", "SKU编码"],
    ["产品类型", "空调类型", "耳机类型", "连接方式", "佩戴方式", "机箱类型", "驱动方式"],
    # 空调相关
